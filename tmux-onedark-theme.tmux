...
if [[ $SHOW_DIRECTORY_NAME -eq 1 ]]; then
    ...
    set "window-status-current-format" "#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_green,nobold] #(basename #{pane_current_path}) / #W #[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
else
    set "window-status-format" "#[fg=$onedark_white,bg=$onedark_black] #I / #W "
    set "window-status-current-format" "#[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]#[fg=$onedark_white,bg=$onedark_green,nobold] #I / #W #[fg=$onedark_green,bg=$onedark_black,nobold,nounderscore,noitalics]"
fi
